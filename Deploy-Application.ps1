...
Try {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# Detects if drivers were installed in root location or instant client folder
		If (Test-Path -Path "$envSystemDrive\ORACLE19_6\instantclient_19_6")
		{
			$installlocation = "$envSystemDrive\ORACLE19_6\instantclient_19_6"
		}
		else {
			$installlocation = "$envSystemDrive\ORACLE19_6"
		}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBFbJs2qCYMRruf
# zIdtrNrsf7q83PverrccG4UrGescAKCCC6EwggWuMIIElqADAgECAhAHA3HRD3la
...
# BgkqhkiG9w0BCQQxIgQgYOP/H3RaWD5KIHPBWoMA3euB5/rk9aw87R7cWa3r9gMw
# DQYJKoZIhvcNAQEBBQAEggEAnJvgOe0YS1QDpszReyBAiUbR/O3dvv4eqpVmQxkB
# yuEzbtj+FcYtMFRcLkhbMxP3dfkZYmRICBUSdpF2pY0I1ZeRpRgdvpyKUK+gyDXN
# fUxv2QQjpwpLL6ZyTW1bjlQNBL05UVEaCHQWhmHsTDmZcX5pc28zCB2WtmIz39d2
# l2mwD0J7HH1WJodH7AuZVRRsNMgT1KwcGVFVR1+66mTE4gFVJcYYRwQ7PEQuyR6E
# wn05OBTs7t7s4FuWKoSGPY4fuQwwWNxaInSTQ8J2MA2R6QhBv948kc5qpwx7O6KF
# t54KcYFHp2usriuLQAe0PiC3WD0MTrECXBTmdcfxTjWB1g==
